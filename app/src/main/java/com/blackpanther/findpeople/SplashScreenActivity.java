...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!mySharedPreferences.getBoolean("flag",false)){
            ...
            new LoginConnect().execute(getResources().getString(R.string.login_url),mySharedPreferences.getString("username","zzz"), mySharedPreferences.getString("password","zzzz"));
        }
