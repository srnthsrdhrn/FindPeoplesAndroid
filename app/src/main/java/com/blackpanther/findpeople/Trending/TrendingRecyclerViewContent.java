 ...
 */
public class TrendingRecyclerViewContent {
    String project_title, project_brief,project_category, project_description;
    List<Likes> likes;
    List<Comments> comments;

    public TrendingRecyclerViewContent(String project_title, String project_brief, String project_category, String project_description, List<Likes> likes, List<Comments> comments) {
